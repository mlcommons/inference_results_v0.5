...
function print_usage () {
	echo 'Usage: ./multi_stream.sh [-i|--input_data <path to input data>] [-c|--class_file <path to classification file>] [-b|--blob_file <path to the compiled blob>] [-o|--output_dir] [--num_devices] [--num_dev_nets_per_device] [--num_parallel_infers]'
...
./cmake-build/loadrun \
      ...
      --multi_stream_target_qps 1.0 \
      --multi_stream_target_latency_ns 50000000 \
