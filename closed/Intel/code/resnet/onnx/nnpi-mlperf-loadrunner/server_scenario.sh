...
function print_usage () {
	echo 'Usage: ./server_scenario.sh [-i|--input_data <path to input data>] [-c|--class_file <path to classification file>] [-b|--blob_file <path to the compiled blob>] [-o|--output_dir] [--num_devices] [--num_dev_nets_per_device] [--num_parallel_infers]'
...
./cmake-build/loadrun \
      ...
      --server_target_latency_ns 15000000 \
      --server_target_qps 9400 \
