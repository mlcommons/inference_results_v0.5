...
function print_usage () {
	echo 'Usage: ./single_stream.sh [-i|--input_data <path to input data>] [-c|--class_file <path to classification file>] [-b|--blob_file <path to the compiled blob>] [-o|--output_dir] [--num_devices] [--num_dev_nets_per_device] [--num_parallel_infers]'
...
./cmake-build/loadrun \
     ...
     --single_stream_target_latency_percentile  0.90 \
