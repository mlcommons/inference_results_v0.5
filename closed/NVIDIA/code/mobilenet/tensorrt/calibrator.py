...
class MobileNetCalibrator(trt.IInt8EntropyCalibrator2):
    def __init__(self, calib_batch_size=1, calib_max_batches=500, force_calibration=False,
        cache_file="code/mobilenet/tensorrt/calibrator.cache",
        image_dir="build/preprocessed_data/imagenet/MobileNet/fp32", calib_data_map="data_maps/imagenet/cal_map.txt"):
