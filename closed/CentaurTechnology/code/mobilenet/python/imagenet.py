...
class Imagenet(dataset.Dataset):
    ...
    def __init__(self, data_path, image_list, name, use_cache=0, image_size=None,
        ...
        self.calibrate_whitelist = []
        # input images are in HWC
        self.need_transpose = True if image_format == "NCHW" else False
        print('use_cache = ' + str(self.use_cache) + ', cache_dir = ' + str(self.cache_dir))
        ...
        if self.calibrate:
            with open(os.getcwd() + '/../../calibration/ImageNet/cal_image_list_option_1.txt', 'r') as f:
                for s in f:
        ...
        with open(image_list, 'r') as f:
            for s in f:
                ...
                if self.calibrate:
                    ...
                    if image_name not in self.calibrate_whitelist:
                        continue
